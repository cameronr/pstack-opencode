...
- Exactly one stacker per stack may run `gt`, serialized within its stack; record the holder in the standing orders. Restacks run as subagents; a restack at this scale takes the machine down if run inline.
