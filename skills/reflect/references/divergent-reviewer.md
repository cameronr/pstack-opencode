...
- `read` tool calls against any `SKILL.md` file (workspace `.opencode/skills/`, user-level `~/.config/opencode/skills/`, or plugin paths configured via `plugin` in opencode.json)
