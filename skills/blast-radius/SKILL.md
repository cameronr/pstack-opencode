...
6. For a big or wide change, run it as an `arena`. Ask several subagent types the same question and merge the answers. Different reviewer types catch different real bugs.
